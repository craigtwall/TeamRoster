...
namespace TeamRoster.Controllers
{
    ...
    {
        private RosterContext db = new RosterContext();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,LastName,FirstName,Age,PlayerNumber,TeamID,Position,Hits")] Player player)
        {
            if (ModelState.IsValid)
            {
